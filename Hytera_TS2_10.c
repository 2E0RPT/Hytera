...
#define UDP_PORT        30014      // Match your Hytera IP Multi-Site service port
...
int main(void) {
    ...
    printf("HyteraTS2 v1.0 by Rob Thompson 2E0RPT.\n");
	printf("Monitor live voice on time slot 2.\n");
