...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    switch (msg) {
        ...
        case WM_COMMAND: {
            ...
            // CH+/CH-/PWR H-L/MSG TS1/MSG TS2 (IDs 6001-6005) are
            // placeholders for now -- no repeater command wired up yet.
            break;
        }
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    HWND hwnd = CreateWindowExA(0, "HyteraHardwarePanelClass", "Hytera Telemetry System By Rob Thompson 2E0RPT",
                                winStyle | WS_VISIBLE,
